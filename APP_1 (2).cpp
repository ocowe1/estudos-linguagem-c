...
main(){
	...
	//Plano de saúde - calculos
		...
		if(planosaude=='s' && conjuge=='s' && quantfilhos==1){
			printf("\nDesconto Plano de Saúde......: R$.2f", planosaude=80.90+65.90);
		}
		else if(planosaude=='s' && conjuge=='s' && quantfilhos==0){
			printf("\nDesconto Plano de Saúde......: R$.2f", planosaude=80.90);
		}
		else if(planosaude=='s' && conjuge=='s' && quantfilhos==2){
			printf("\nDesconto Plano de Saúde......: R$.2f", planosaude=80.90+(65.90*2));
		}
		else if(planosaude=='s' && conjuge=='s' && quantfilhos==3){
			printf("\nDesconto Plano de Saúde......: R$.2f", planosaude=80.90+(65.90+3));
		}
				else if(planosaude=='s' && conjuge=='n' && quantfilhos==0){
			printf("\nDesconto Plano de Saúde......: R$.2f", planosaude=21.90);			
		}
		else if(planosaude=='s' && conjuge=='n' && quantfilhos==1){
			printf("\nDesconto Plano de Saúde......: R$.2f", planosaude=65.90);			
		}
		else if(planosaude='s' && conjuge=='n' && quantfilhos==2){
			printf("\nDesconto Plano de Saúde......: R$.2f", planosaude=65.90*2);			
		}
		else if(planosaude=='s' && conjuge=='n' && quantfilhos==3){
			printf("\nDesconto Plano de Saúde......: R$.2f", planosaude=65.90*3);			
		} 
		
	//Plano Odontológico - calculos
		if(planoodonto=='s' && conjuge=='s' && quantfilhos==0){
			printf("\nDesconto Plano Odontológico..: R$.2f", planoodonto=35.00);
		}
		else if(planoodonto=='s' && conjuge=='n' && quantfilhos==0){
			printf("\nDesconto Plano Odontológico..: R$.2f", planoodonto=40.00);			
		}
		else if(planoodonto=='s' && conjuge=='s' && quantfilhos==1){
			printf("\nDesconto Plano Odontológico..: R$.2f", planoodonto=(35-5)+(40-5));
		}
		else if(planoodonto=='s' && conjuge=='s' && quantfilhos==2){
			printf("\nDesconto Plano Odontológico..: R$.2f", planoodonto=(35-5)+(40-5)+(40-5));			
		}
		else if(planoodonto=='s' && conjuge=='s' && quantfilhos==3){
			printf("\nDesconto Plano Odontológico..: R$.2f", planoodonto=(35-5)+(40-5)+(40-5)+(40-5));			
		}
		else if(planoodonto=='s' && conjuge=='n' && quantfilhos==1){
			printf("\nDesconto Plano Odontológico..: R$.2f", planoodonto=(40-5)+(40-5));		
		}
		else if(planoodonto=='s' && conjuge=='n' && quantfilhos==2){
			printf("\nDesconto Plano Odontológico..: R$.2f", planoodonto=(40-5)+(40-5)+(40-5));	
		}
		else if(planoodonto=='s' && conjuge=='n' && quantfilhos==3){
			printf("\nDesconto Plano Odontológico..: R$.2f", planoodonto=(40-5)+(40-5)+(40-5)+(40-5));				
		}		
